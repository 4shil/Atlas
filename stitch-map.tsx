        ...
        <View className="flex-1 bg-black">
            ...
            <View className="relative h-[60%] w-full bg-[#050505] z-10 overflow-hidden">
                ...
                <View className="absolute top-0 left-0 right-0 pt-16 px-6 flex-row justify-between items-start z-30 pointer-events-box-none">
                    <TouchableOpacity className="w-10 h-10 rounded-full bg-black/50 items-center justify-center shadow-lg border border-white/10 active:bg-black/70">
                ...
                <ScrollView className="flex-1 px-6 pb-8 pt-2" showsVerticalScrollIndicator={false}>
                    ...
                    <View className="mb-8">
                        ...
                        <View className="flex-row items-center justify-between">
                            ...
                            <TouchableOpacity className="w-12 h-12 rounded-full bg-[#1A1A1A] border border-white/5 items-center justify-center active:bg-[#222]">
