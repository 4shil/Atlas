...
const INSPIRATIONS = [
    {
        id: 'i1', title: 'Northern Lights in Iceland', category: 'Travel',
    ...
    {
        id: 'i2', title: 'Safari in the Serengeti', category: 'Adventures',
    ...
    {
        id: 'i3', title: 'Street Food Tour in Bangkok', category: 'Foodie',
    ...
    {
        id: 'i4', title: 'Overwater Bungalow in Bora Bora', category: 'Stays',
        ...
        location: { latitude: -16.5004, longitude: -151.7415, city: 'Bora Bora', country: 'French Polynesia' },
    },
    {
        id: 'i5', title: 'Hike Machu Picchu', category: 'Adventures',
        ...
        location: { latitude: -13.1631, longitude: -72.5450, city: 'Cusco', country: 'Peru' },
    },
    {
        id: 'i6', title: 'Cherry Blossoms in Kyoto', category: 'Travel',
    ...
    {
        id: 'i7', title: 'Italian Truffle Dinner', category: 'Foodie',
    ...
    {
        id: 'i8', title: 'Glacier Hike in Patagonia', category: 'Adventures',
        ...
        location: { latitude: -50.4960, longitude: -73.1468, city: 'El Calafate', country: 'Argentina' },
    },
    {
        id: 'i9', title: 'Santorini Sunset Stay', category: 'Stays',
    ...
    {
        id: 'i10', title: 'Dive the Great Blue Hole', category: 'Adventures',
        ...
        location: { latitude: 17.3165, longitude: -87.5340, city: 'Belize City', country: 'Belize' },
    },
    {
        id: 'i11', title: 'Ramen Crawl in Sapporo', category: 'Foodie',
    ...
    {
        id: 'i12', title: 'The Trans-Siberian Railway', category: 'Travel',
...
export default function Inspiration() {
    ...
    const handleAdd = (item: typeof INSPIRATIONS[0]) => {
        ...
        addGoal({
            ...
            image: item.image,
            timelineDate: new Date(new Date().setFullYear(new Date().getFullYear() + 1)).toISOString(),
            notes: '',
        ...
        <View className="flex-1 bg-black">
                ...
                <View className="px-6 pt-3 pb-4">
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {FILTERS.map(f => (
                            ...
                            >
                                <Text className={`text-xs font-medium ${activeFilter === f ? 'text-white' : 'text-gray-400'}`}>{f}</Text>
                            </TouchableOpacity>
                        ))}
                    </ScrollView>
                </View>
            ...
            >
                ...
                {filtered.map(item => {
                    ...
                    return (
                        <View key={item.id} className="rounded-3xl overflow-hidden mb-4 border border-white/8 bg-gray-950">
                            {/* Image */}
                            <View className="h-48 relative">
                                ...
                                <View className="absolute top-4 left-4 bg-black/50 border border-white/15 px-3 py-1 rounded-full flex-row items-center">
                                    <MaterialIcons name={categoryIcon(item.category) as any} size={12} color="white" />
                                    <Text className="text-white text-xs ml-1.5 font-medium">{item.category}</Text>
                                </View>
                                {/* Location chip */}
                                <View className="absolute bottom-4 left-4 flex-row items-center">
                                    <MaterialIcons name="place" size={14} color="#60a5fa" />
                                    <Text className="text-blue-300 text-xs ml-1 font-medium">{item.location.city}, {item.location.country}</Text>
                                </View>
                            </View>
                            ...
                            <View className="p-4 flex-row items-start">
                                <View className="flex-1 mr-3">
                                    ...
                                    <Text className="text-gray-400 text-sm leading-5" numberOfLines={2}>{item.description}</Text>
                                </View>
                                <TouchableOpacity
