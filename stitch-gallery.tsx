        ...
        <SafeAreaView className="flex-1 bg-black relative" edges={['top', 'bottom']}>
            ...
            <View className="flex-1 z-10">
                ...
                <View className="px-6 mt-4 flex-row justify-between items-center">
                    ...
                    <TouchableOpacity className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shadow-lg active:bg-white/10">
                ...
                <View className="flex-1 items-center justify-center relative w-full mb-12">
                    <View className="w-full h-[480px] relative items-center justify-center pt-8">
                        ...
                        <View className="absolute left-[-25px] scale-90 w-[260px] h-[380px] bg-black/40 rounded-[24px] border border-white/10 shadow-2xl z-10 overflow-hidden" style={{ transform: [{ scale: 0.9 }, { rotate: '-6deg' }], opacity: 0.7 }}>
                        ...
                        {/* Right Card -> Safari */}
                        <View className="absolute right-[-25px] scale-90 w-[260px] h-[380px] bg-black/40 rounded-[24px] border border-white/10 shadow-2xl z-10 overflow-hidden" style={{ transform: [{ scale: 0.9 }, { rotate: '6deg' }], opacity: 0.7 }}>
                        ...
                        <View className="relative w-[280px] h-[440px] bg-gray-900 rounded-[24px] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.7)] z-20 flex flex-col overflow-hidden">
            ...
            <View className="absolute bottom-10 left-0 right-0 z-30 flex-row justify-center" pointerEvents="box-none">
                <TouchableOpacity className="bg-black/80 pl-5 pr-6 py-3.5 rounded-full flex-row items-center border border-white/20 shadow-lg shadow-white/10 active:scale-95">
